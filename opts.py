...
def opts():
    ...
    parser.add_argument('--dynamic_weight_alpha', type=float, default=0.5, help='Alpha parameter for dynamic weight adjustment')
    parser.add_argument('--self_supervised', type=bool, default=True, help='Enable self-supervised training')
    parser.add_argument('--perturbation_strength', type=float, default=0.1, help='Strength of perturbation for self-supervised training')
